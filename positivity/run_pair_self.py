...
AUG_BASE_DIR = os.path.join(PROJECT_ROOT, "positivity", "augmented_self_supervised")
...
def main():
    ...
    for n in SAMPLE_SIZES:
        ...
        for data_name, orig_path in orig_datasets.items():
            ...
            for syn_name, syn_path in SYN_SOURCES.items():
                ...
                print(f"Finished self pair | n={n} | {data_name} | {syn_name}")
    ...
    out_json = os.path.join(RESULTS_DIR, "self_supervised_pair_results_by_n.json")
